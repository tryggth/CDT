#ifndef __vvCentered2p1SI__hpp__
#define __vvCentered2p1SI__hpp__
...
{
public:
  vvCentered2p1( const char* infilename, 
...
private:
  ...
  // prohibit copying
  vvCentered2p1( void );
  vvCentered2p1( const vvCentered2p1& );
  vvCentered2p1& operator=( const vvCentered2p1& );
};

#endif // __vvCentered2p1SI__hpp__
